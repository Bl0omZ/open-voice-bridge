...
**下载：** [小米遥控器桥接 v0.3.0 测试版（macOS，universal）](https://github.com/Bl0omZ/open-voice-bridge/releases/latest)
...
1. 从 [v0.3.0 测试版 Release](https://github.com/Bl0omZ/open-voice-bridge/releases/tag/v0.3.0) 下载 `小米遥控器桥接-0.3.0-测试版.dmg`；
